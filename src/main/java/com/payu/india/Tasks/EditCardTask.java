 ...
 * Async task which takes care of editing a card
 * Takes PayuConfig as input and sends PayuResponse to the calling activity
 * Activity which calls {@link EditCardTask } should implement {@link EditCardApiListener}
 */
public class EditCardTask extends AsyncTask<PayuConfig, String, PayuResponse> {
    ...
    public EditCardTask(EditCardApiListener editCardApiListener) {
        mEditCardApiListener = editCardApiListener;
    }
    ...
    protected void onPostExecute(PayuResponse payuResponse) {
        ...
        mEditCardApiListener.onEditCardApiListener(payuResponse);
    }
}
